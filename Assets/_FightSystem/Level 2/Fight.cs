...
namespace _2023_GC_A2_Partiel_POO.Level_2
{
    public class Fight
    {
        ...
        {
            if(character1 == null || character2 == null || (character1 == null && character2 == null))
            {
        ...
        /// </summary>
        public bool IsFightFinished => !Character1.IsAlive || !Character2.IsAlive ? true : false;
        ...
        public void ExecuteTurn(Skill skillFromCharacter1, Skill skillFromCharacter2)
        {
            ...
            {
                Character2.ReceiveAttack(skillFromCharacter1, Character2);
            }
